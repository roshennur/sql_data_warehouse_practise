...
BEGIN
	...
	-- Truncate & Inserting data into silver.crm_cust_info
	...
	-- Truncate & Inserting data into silver.crm_prd_info
	...
	SELECT 
	prd_id,
	SUBSTRING(prd_key, 7, LENGTH(prd_key)) AS prd_key, 		-- Extract category ID
	...
	-- Truncate & Inserting data into silver.crm_sales_details
	...
	-- Truncate & Inserting data into silver.erp_cust_az12
	...
	-- Truncate & Inserting data silver.into erp_loc_a101
	...
	-- Truncate & Inserting data into silver.erp_px_cat_g1v2
